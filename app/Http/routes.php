...
Route::get('/', function () {
//    dd(DB::connection('mongodb')->collection('keys')->where('type','company')->get());
...
');
//    $pdf = $pdf->setOption('margin-bottom', 1);
//    $pdf = $pdf->setOption('margin-top', 10);
//    $pdf = $pdf->setOption('margin-left', 1);
//    $pdf = $pdf->setOption('margin-right', 1);
//    $pdf = $pdf->setOption('footer-center', 'merge?');
    return $pdf->setOption('margin-right', 1)->setOption('margin-left', 1)->setOption('footer-center', 'merge?')->stream();
});
